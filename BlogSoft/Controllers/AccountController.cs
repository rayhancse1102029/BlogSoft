...
using FBAI.Areas.User.Models;
using FBAI.Data;
using FBAI.Data.Entity;
using FBAI.Helpers;
using FBAI.Models.AccountViewModels;
using FBAI.Service.Helper.Interfaces;
using FBAI.Service.Interface;
using FBAI.Service.MasterData.Interfaces;
...
namespace FBAI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register()
        {
            ...
            {
                genders = await _iGenderService.GetAllGender()
            };
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ApplicationUser findUser = await _userManager.FindByNameAsync(model.Email);
        ...
        //List<UserRoleViewModel> roles = await(from role in _context.UserRoles.Where(x => x.UserId == user.Id)
        ...
        //{
        //    IdentityRole r = await _context.Roles.FindAsync(role.roleId);

        //    if (r.Name == "GeneralUser")
        //    {
        //        return RedirectToAction("RegistrationSuccessMsg", "Account");
        //    }
        //    else if (r.Name == "ProcessFileUser" || r.Name == "Account" || r.Name == "Admin" || r.Name == "Developer")
        //    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        IList<string> getAllRoles = await _userManager.GetRolesAsync(user);

                        if (getAllRoles.Contains("GeneralUser"))
                        {
                            return RedirectToAction("RegistrationSuccessMsg", "Account");
                        }
                        else
